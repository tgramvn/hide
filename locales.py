...
# TOO_LONG_TITLE
locale_en.too_long_title = 'Tin nhắn của bạn quá dài'
...
# EXCEPT_TITLE
locale_en.except_title = 'Ngoại trừ %s'
...
# TOO_LONG_MESSAGE
locale_en.too_long_message = '🥺 Rất tiếc, không thể gửi tin nhắn của bạn vì nó vượt quá giới hạn 200 ký tự.'
...
# FOR_MESSAGE
locale_en.for_message = 'Giftcode đã được gửi cho %s.'
...
# EXCEPT_MESSAGE
locale_en.except_message = 'Giftcode cho tất cả mọi người ngoại trừ %s.'
...
# SPOILER_MESSAGE
locale_en.spoiler_message = 'Tin nhắn spoiler công khai.'
...
locale_en.group_greeting_message = (
        '👋 <b>HỆ THỐNG MINIGAME MOMO - CHẴN LẺ - TÀI XỈU - UY TÍN SỐ 1 VIỆT NAM 🇻')
...
locale_en.info_message = (
        '<b>HỆ THỐNG MINIGAME MOMO - CHẴN LẺ - TÀI XỈU - UY TÍN SỐ 1 VIỆT NAM 🇻🇳\n\n'
        '⭐ Hệ thống 1 ➩ CLMM.BABY\n\n'
        '⭐ Hệ thống 2 ➩ CLMM.CO\n\n'
        '⭐ Hệ thống 3 ➩ MOMO86.CLUB\n\n'
        '⭐ Hệ thống 4 ➩ MM63.CLUB</b>\n\n'
        '<i>Minigame giải trí cách chơi là dự đoán mã giao dịch của MoMo.'
        'Bạn thắng bạn sẽ nhận được thưởng trong 5 giây. Uy tín số 1 Việt Nam.</i>')
...
# HOW_TO_USE
locale_en.how_to_use = 'Hướng dẫn sử dụng?'
...
locale_en.too_long_description = 'Vui lòng rút ngắn độ dài của tin nhắn để không vượt quá giới hạn 200 ký tự.'
...
# NOT_ALLOWED
locale_en.not_allowed = 'Giftcode này đéo dành cho mày, cút chỗ khác!'
...
# NOT_ACCESSIBLE
locale_en.not_accessible = 'Giftcode này không thể truy cập được nữa.'
...
# VIEW
locale_en.view = '👁‍🗨 XEM CODE TẠI ĐÂY'
